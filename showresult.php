...
if(isset($_POST['submit']))
{
    ...
    <div class="container">
        <table class="table table-striped">
            <tr>
                <th colspan="4"> <h4 align="center"> Result </h4> </th>
            </tr>
            <?php
            if($num<=$i)
            {
